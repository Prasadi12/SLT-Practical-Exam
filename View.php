...
<head>
    ...
    <style type="text/css">
        ...
        .slider-1{height:400px; background-repeat:no-repeat; background-size:cover; background-position:center;}
        .font-2{font-family: 'Gowun Batang', serif; color:#0f405c; font-weight: 800;}
   	</style>
    <!-- Theme classes end-->
</head>
...
<!-- nav_bar -->
  ...
  <div class="container-fluid slider-1 my-0" >
    <center>
      <h1 class="font-2 clf-1 text-center font-2 text-warning bg-dark w-50">MY ACCOUNTS</h1>
        <div class="container mt-0 mb-5">
          <table class="table table-hover w-65">
            <thead>
                <tr class="table-info">
                    <th scope="col">#</th>
